# Changelog — GSD (Framework del Agente IA)

> [!NOTE]
> Este archivo registra cambios del framework **GSD (Get Shit Done)** para Antigravity,
> que es la herramienta de planificación del agente IA. **No corresponde al código del proyecto PUCV2.**
> El changelog del proyecto está en `../CHANGELOG.md`.
