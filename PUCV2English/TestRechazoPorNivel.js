 ...
 */
function testGenerarListaFinal_NivelValido() {
 ...
 */
function testGenerarListaFinal_NivelInsuficiente() {
 ...
 */
function testGenerarListaFinal_SinResultado() {
    const result = generarListaFinalCurso();
 ...
 */
function testRenderCorreoInicioClases_FraseNivel() {
 ...
 */
function testEnviarCorreosRechazoPorNivel_Idempotencia() {
